 ...
 * CMS data, so this list is a hand-maintained mirror of six of the seven
 * WordPress services (CMS titles and slugs are the source of truth —
 * ARCH-1, CLIENT-6). ZOHO CRM is intentionally excluded from this public
 * listing. Every entry links its /services/{slug} detail page; nothing here
 * may point at a retired bespoke route such as /services/seo.
 */
