...
const journey = [
  {
    ...
    description: "We decode your business, map the market, and pinpoint the exact audience worth chasing.",
    points: ["Understand the business", "Research opportunities", "Identify ideal audience"],
  },
  {
    icon: Palette,
    title: "Strategy & Identity",
    description: "We build the strategy, design the experiences, and craft a brand identity that commands attention.",
    points: ["Build strategy", "Design experiences", "Create brand identity"],
  },
  {
    icon: Rocket,
    title: "Launch, Optimize, Scale",
    description: "We ship fast, measure everything, and double down on what compounds.",
        ...
        >
          <Card className="flex h-full flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-body text-xs text-muted">0{index + 1}</span>
            </div>
